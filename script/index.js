AFRAME.registerComponent('worksdetail', {
  schema: {
    name: {type: 'string'},
    rotated: {type: 'bool'},
  ...
  init: function () {
    ...
    const {title, artist, caption} = JSON.parse(this.data.metadata)
    ...
    infoDisplay.setAttribute('info-display', {title, artist, caption})
...
AFRAME.registerPrimitive('worksdetail', {
  ...
  mappings: {
    ...
    rotated: 'worksdetail.rotated',
    metadata: 'worksdetail.metadata',
  }
})
